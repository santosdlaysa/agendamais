      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg p-8 border border-blue-100">
        <div className="text-center max-w-md mx-auto">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white py-3 px-6 rounded-lg font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
          >
            Ver Planos e Preços
        ...
        <div className="text-center max-w-md mx-auto">
          ...
          <div className="bg-white rounded-lg p-4 mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600">Seu plano atual:</span>
              <span className="font-semibold text-gray-900">{currentPlanName}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Upgrade necessário:</span>
