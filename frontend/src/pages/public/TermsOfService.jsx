    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-12">
          ...
          <p className="text-gray-500 mb-8">Ultima atualização: {new Date().toLocaleDateString('pt-BR')}</p>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Uso Aceitável</h2>
              <p className="text-gray-600 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">8. Disponibilidade do Serviço</h2>
              <p className="text-gray-600">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">9. Modificações nos Termos</h2>
              <p className="text-gray-600">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">10. Cancelamento e Encerramento</h2>
              <p className="text-gray-600 mb-4">
