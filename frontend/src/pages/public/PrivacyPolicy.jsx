        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.1 Dados fornecidos por você:</h3>
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-6 mb-3">2.2 Dados coletados automaticamente:</h3>
              <ul className="list-disc pl-6 text-gray-600 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Armazenamento e Segurança</h2>
              <p className="text-gray-600 mb-4">
